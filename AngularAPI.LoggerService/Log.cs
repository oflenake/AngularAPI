...
namespace AngularAPI.LoggerService
{
    // Singleton Log class which also includes targets for Sentinel and Harvester viewers, when running a debug build.
    public static class Log
    {
        ...
        {
#if DEBUG
            // Setup logging view for Sentinel - http://sentinel.codeplex.com
